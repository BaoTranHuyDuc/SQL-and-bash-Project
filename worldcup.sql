...
--
-- Name: name_overlap; Type: TABLE; Schema: public; Owner: freecodecamp
--

CREATE TABLE public.name_overlap (
    name_overlap character varying(60) NOT NULL,
    name_overlap_id integer NOT NULL
);


ALTER TABLE public.name_overlap OWNER TO freecodecamp;

--
-- Name: name_overlap_name_overlap_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.name_overlap_name_overlap_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.name_overlap_name_overlap_id_seq OWNER TO freecodecamp;

--
-- Name: name_overlap_name_overlap_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.name_overlap_name_overlap_id_seq OWNED BY public.name_overlap.name_overlap_id;
...
--
-- Name: name_overlap name_overlap_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.name_overlap ALTER COLUMN name_overlap_id SET DEFAULT nextval('public.name_overlap_name_overlap_id_seq'::regclass);
...
--
-- Data for Name: name_overlap; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--
...
--
-- Name: name_overlap_name_overlap_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.name_overlap_name_overlap_id_seq', 1, false);
